...
namespace GIBS.Modules.GIBS_UMGslider.Data
{
    ...
    public class SqlDataProvider : DataProvider
    {
        ...
        private const string ModuleQualifier = "GIBS_UMGslider_";
        ...
        public override IDataReader GetItems(int albumID, int maxCount, int moduleID)
        {
            return SqlHelper.ExecuteReader(ConnectionString, NamePrefix + "GetItems", albumID, maxCount, moduleID);
        }

        public override IDataReader GetAlbums(int portalId)
        {
            return SqlHelper.ExecuteReader(ConnectionString, "UMG_AlbumListByPortal", portalId);
        }
