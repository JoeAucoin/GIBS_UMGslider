...
namespace GIBS.Modules.GIBS_UMGslider.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "GIBS.Modules.GIBS_UMGslider.Data.SqlDataprovider,GIBS_UMGslider";
        ...
        public abstract IDataReader GetItems(int albumID, int maxCount, int moduleID);

        //public abstract IDataReader GetItem(int itemId);        

        public abstract IDataReader GetAlbums(int portalId);
